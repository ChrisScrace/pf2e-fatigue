# 1.4.0
* Updating compatibility info to v12
* Replacing use of deprecated code
...
# 1.2.0
* when a player has the Forge Day's Rest feat they will be asked if their rest was 12 hours and if so will adjust the timer accordingly
